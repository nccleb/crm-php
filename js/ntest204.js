...
function openPopupWin()
	{
		...
		var url = 'http://192.168.16.103/test204.php?pag=<?php echo $nam ?>&pag1=<?php echo $idf ?>';
...
function myFunction2() {
    window.open ("http://192.168.16.103//test154.php","","menubar=0,resizable=1,width=900,height=500");
}
  

 
function myFunction3() {
   window.open ("http://192.168.16.103/test168.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>&page2=<?php echo urlencode($inc)?>","","menubar=0,resizable=1,width=2000,height=2000");
}
...
function myCalendar() {
   window.open ("http://192.168.16.103/test300.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>&page2=<?php echo urlencode($inc)?>","","menubar=0,resizable=1,width=2000,height=2000");
}
...
function myFunction4() {
   window.open ("http://192.168.16.103//test237.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>","","menubar=0,resizable=1,width=1450,height=800");
}
...
function collect() {
   window.open ("http://192.168.16.103//test15.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>","","menubar=0,resizable=1,width=1450,height=800");
}
...
function search5(){
myw=window.open ("http://192.168.16.103//search.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>&page2=<?php echo urlencode($inc)?>","","menubar=0,resizable=1,width=1000,height=950");	
...
function crr(){
myw=window.open ("http://192.168.16.103//test240.php?pag=<?php echo $nam ?>&pag1=<?php echo $idf ?>&page2=<?php echo $inc ?>","","menubar=0,resizable=1,width=1050,height=1000");	
...
function number(){
myw=window.open ("http://192.168.16.103//numbersearch.php?page=<?php echo urlencode($nam) ?>&page1=<?php echo urlencode($idf)?>&page2=<?php echo urlencode($inc)?>","","menubar=0,resizable=1,width=1050,height=1000");	
...
function history(){
 ...
 window.open ("http://192.168.16.103//test29.php","","menubar=0,resizable=1,width=480,height=350");
...
function deldriver(){
 ...
 window.open ("http://192.168.16.103//test206.php","","menubar=0,resizable=1,width=480,height=350");
...
function update(){
   ...
   myw=window.open ("http://192.168.16.103//test27.php","","menubar=0,resizable=1,width=480,height=750");
...
function addCrm(){
	...
	myw=window.open ("http://192.168.16.103//test56.php?page=<?php echo $nam ?>&page1=<?php echo $idf ?>&page2=<?php echo $inc ?>","","menubar=0,resizable=1,width=450,height=800");
}
...
function updateCrm(){
	...
	myw=window.open ("http://192.168.16.103//before.php?pag=<?php echo $nam ?>&pag1=<?php echo $idf ?>&pag2=<?php echo $inc ?>","","menubar=0,resizable=1,width=500,height=800");
}
