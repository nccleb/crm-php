...
function add(){
        ...
        let glob2 = global2;
        let glob3 = global3;
    myw=window.open ("http://192.168.16.102/test56.php?page=" + encodeURI(glob)+"&page1="+ encodeURI(glob1) +"&page2="+ encodeURI(glob2) +"&page3="+ encodeURI(glob3),"","menubar=0,resizable=1,width=600,height=950");	
    }
