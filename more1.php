...
fieldval = document.getElementById("pri").value;
		
       document.getElementById("pr").value = fieldval;
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="pr" placeholder="" name="pr"     >
</div><br>
...
<input type="hidden" id="pri" value="<?php echo $pr?>">
