...
for ($i=1;$i<=$lig12["co"];$i++){
   ...
   $stmt->execute();
	 ...
	 $idr1 = mysqli_connect("192.168.22.107", "root", "1Sys9Admeen72", "nccleb_test");
if (mysqli_connect_errno()) {
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
  exit();
}
  ...
  if (r == true) {
location.replace (\"http://192.168.22.107//test321.php?page=$naa&page1=$idf&page2=$incc\",\"menubar=0,resizable=1,width=1000,height=950\");
  } else {
  window.close()
  }
