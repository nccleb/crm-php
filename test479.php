...
curl_setopt($curlHandle, CURLOPT_RETURNTRANSFER, true);
 ...
 <body onload="size242()" >
 <p style="text-align:center;font-size:25px;" id="form"        >Pause Log</p>
 <div class="jumbotron"> 
 <table>
 <tr><th>queuechairman</th><th>extension</th><th>agent</th><th>pause_date</th><th>unpause_date</th><th>pause_time</th></tr>
 <?php 
      ...
      foreach ($ch->queue_statistics as $key => $value) {
         ...
         if( $value->agent->agent != "NONE"    ){
                ...
                echo	"<tr><td>"."<a>" .$value->agent->queuechairman  ." </a>"."</td><td>"."<a  \">" .$value->agent->extension . " </a></li>\n"."</td>"."<td>"."<a>".$value->agent->agent."</a>"."</td>"."<td>"."<a>".$value->agent->pause_data."</a>"."</td>"."<td>"."<a>".$value->agent->unpause_data."</a>"."</td>"."<td>"."<a>".$value->agent->pause_time."</a>"."</td>"."</tr>";
