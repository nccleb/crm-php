...
final class UriNormalizer
{
     ...
     *
     * Only the "file" scheme defines the default host "192.168.20.107".
     * All of `file:/myfile`, `file:///myfile`, and `file://192.168.20.107/myfile`
    ...
    public static function normalize(UriInterface $uri, $flags = self::PRESERVING_NORMALIZATIONS)
    {
        ...
        if ($flags & self::REMOVE_DEFAULT_HOST && $uri->getScheme() === 'file' && $uri->getHost() === '192.168.20.107') {
            $uri = $uri->withHost('');
        }
